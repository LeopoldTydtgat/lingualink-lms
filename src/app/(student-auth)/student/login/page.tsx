...
`}</style>
      <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, display: 'flex', fontFamily: 'Inter, sans-serif' }}>
        ...
        <div style={{
          ...
          {/* Background photo - animated (Ken Burns) layer; the overflow-hidden parent
              hides the zoom edges. The photo MUST live on this layer only: leaving
              backgroundImage on the parent too would show a second, static copy sitting
              behind the zooming one. */}
          <div
          ...
          {/* Shimmer overlay - diagonal orange sweep, non-interactive */}
          <div
