...
CREATE OR REPLACE FUNCTION "public"."book_class_atomic"("p_training_id" "uuid", "p_hours_needed" numeric) RETURNS "void"
...
declare
  ...
  v_status text;
begin
  select total_hours, hours_consumed, status
    into v_total, v_consumed, v_status
  ...
  update public.trainings
     set hours_consumed = v_consumed + p_hours_needed
   where id = p_training_id;
end;
$$;


ALTER FUNCTION "public"."book_class_atomic"("p_training_id" "uuid", "p_hours_needed" numeric) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."change_duration_atomic"("p_lesson_id" "uuid", "p_old_duration_minutes" integer, "p_new_duration_minutes" integer) RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."change_duration_atomic"("p_lesson_id" "uuid", "p_old_duration_minutes" integer, "p_new_duration_minutes" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."complete_report_atomic"("p_report_id" "uuid", "p_lesson_status" "text", "p_report_payload" "jsonb") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."complete_report_atomic"("p_report_id" "uuid", "p_lesson_status" "text", "p_report_payload" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."flag_overdue_reports"() RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."flag_overdue_reports"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."lesson_end_time"("starts_at" timestamp with time zone, "duration_minutes" integer) RETURNS timestamp with time zone
...
ALTER FUNCTION "public"."lesson_end_time"("starts_at" timestamp with time zone, "duration_minutes" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."refund_hours_atomic"("p_training_id" "uuid", "p_hours" numeric, "p_lesson_id" "uuid" DEFAULT NULL::"uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."refund_hours_atomic"("p_training_id" "uuid", "p_hours" numeric, "p_lesson_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."reschedule_class_atomic"("p_old_lesson_id" "uuid", "p_student_id" "uuid", "p_training_id" "uuid", "p_old_duration_hours" numeric, "p_new_duration_hours" numeric) RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."reschedule_class_atomic"("p_old_lesson_id" "uuid", "p_student_id" "uuid", "p_training_id" "uuid", "p_old_duration_hours" numeric, "p_new_duration_hours" numeric) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."unwind_reschedule_atomic"("p_old_lesson_id" "uuid", "p_training_id" "uuid", "p_old_duration_hours" numeric, "p_new_duration_hours" numeric) RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."unwind_reschedule_atomic"("p_old_lesson_id" "uuid", "p_training_id" "uuid", "p_old_duration_hours" numeric, "p_new_duration_hours" numeric) OWNER TO "postgres";
...
ALTER TABLE "public"."hours_log" OWNER TO "postgres";
...
ALTER TABLE "public"."student_reviews" OWNER TO "postgres";
...
ALTER TABLE "public"."study_sheets" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."teacher_history_log" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "teacher_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."teacher_history_log" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."training_teachers" (
    "training_id" "uuid" NOT NULL,
    "teacher_id" "uuid" NOT NULL,
    "assigned_at" timestamp with time zone DEFAULT "now"() NOT NULL
);
...
ALTER TABLE "public"."training_teachers" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."user_action_attempts" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "user_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."user_action_attempts" OWNER TO "postgres";
...
GRANT ALL ON FUNCTION "public"."book_class_atomic"("p_training_id" "uuid", "p_hours_needed" numeric) TO "anon";
GRANT ALL ON FUNCTION "public"."book_class_atomic"("p_training_id" "uuid", "p_hours_needed" numeric) TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."change_duration_atomic"("p_lesson_id" "uuid", "p_old_duration_minutes" integer, "p_new_duration_minutes" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."change_duration_atomic"("p_lesson_id" "uuid", "p_old_duration_minutes" integer, "p_new_duration_minutes" integer) TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."refund_hours_atomic"("p_training_id" "uuid", "p_hours" numeric, "p_lesson_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."refund_hours_atomic"("p_training_id" "uuid", "p_hours" numeric, "p_lesson_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."refund_hours_atomic"("p_training_id" "uuid", "p_hours" numeric, "p_lesson_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."reschedule_class_atomic"("p_old_lesson_id" "uuid", "p_student_id" "uuid", "p_training_id" "uuid", "p_old_duration_hours" numeric, "p_new_duration_hours" numeric) TO "anon";
GRANT ALL ON FUNCTION "public"."reschedule_class_atomic"("p_old_lesson_id" "uuid", "p_student_id" "uuid", "p_training_id" "uuid", "p_old_duration_hours" numeric, "p_new_duration_hours" numeric) TO "authenticated";
