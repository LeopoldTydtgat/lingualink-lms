...
export default async function StudentAccountPage() {
  ...
  const { data: student, error: studentError } = await admin
    .from('students')
    .select('id, auth_user_id, full_name, email, photo_url, phone, timezone, language_preference, learning_goals, interests, company_id, customer_number, is_private, academic_advisor_id, status, native_language, learning_language, current_fluency_level, created_at, updated_at')
