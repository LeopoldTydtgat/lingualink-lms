...
// ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Progress bar component ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬
...
export default function ProgressClient({
  ...
  const endDate = training?.end_date ? formatDate(training.end_date, timezone) : 'ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“'

  // ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Lesson history ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬
  ...
  // ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Radar chart data ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬
  ...
  // ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Exercises ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬
        ...
        {training ? (
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
              ...
              <StatCard label="Hours Used" value={`${hoursUsed}h`} />
              <StatCard
                label="Hours Remaining"
                value={`${hoursRemaining}h`}
                sub={hoursRemaining < 2 ? 'ÃƒÂ¢Ã…Â¡Ã‚Â ÃƒÂ¯Ã‚Â¸Ã‚Â Running low' : undefined}
              />
              <StatCard
                label="Training Ends"
                value={endDate}
            ...
            <div className="bg-white rounded-xl border border-gray-100 p-5 shadow-sm space-y-2">
              <div className="flex justify-between text-sm text-gray-600">
                ...
                <span className="font-medium">
                  {hoursUsed}h of {totalHours}h ({totalHours > 0 ? Math.round((hoursUsed / totalHours) * 100) : 0}%)
                </span>
              </div>
        ...
        {radarData.length > 0 ? (
          <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
            <ResponsiveContainer width="100%" height={320}>
              <RadarChart data={radarData} margin={{ top: 10, right: 30, bottom: 10, left: 30 }}>
                ...
                <Radar
                  ...
                  strokeWidth={2}
                />
                {/* value typed as number | undefined ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â recharts passes ValueType which includes undefined */}
                <Tooltip
            ...
            <div className="mt-4 flex flex-wrap gap-3 justify-center">
              {radarData.map(d => (
                <div key={d.skill} className="flex items-center gap-1.5 text-xs text-gray-600">
                  <span
            ...
            <p className="text-xs text-gray-400 text-center mt-4">
              Scale: A1 ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ A1+ ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ A2 ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ A2+ ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ B1 ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ B1+ ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ B2 ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ B2+ ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ C1 ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ C1+ ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ C2
            </p>
          </div>
        ) : (
          <div className="bg-white rounded-xl border border-gray-100 p-6 text-center text-gray-400 text-sm shadow-sm">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          <StatCard
            ...
            value={String(totalLessonsCount)}
            sub="all time"
          />
          <StatCard
